...
<body>
	...
	<div id="allpage" style="background-color: #FFDDAA">
		...
		<form
			...
			method="get">
			<table height="400px" width="900px" class="t2" align="center">
				<tr style="border: 1px solid black">
					<td align="right" >促銷方案活動編號：</td>
					<td><input type="text" name="PTP_PROJID"
						value="${param.PTP_PROJID}"><span class="error">${error.pTP_PROJID}</span></td>
				</tr>
				<tr >
					<td align="right">促銷方案活動名稱：</td>
					<td><input type="text" name="PTP_NAME"
						value="${param.PTP_NAME}"><span class="error">${error.pTP_NAME}</span></td>
				</tr>
				<tr>
					<td align="right">活動內容文字說明：</td>
					<td><textarea rows="3" cols="50" name="PTP_DESC">${param.PTP_DESC}</textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="PTP_CREATEDATE"
						id="PTP_CREATEDATE" value="${param.PTP_CREATEDATE}"></td>
				</tr>
				<tr>
					<td align="right">促銷活動結束日期：</td>
					<td><input type="text" name="PTP_DELDATE" id="PTP_DELDATE"
						value="${param.PTP_DELDATE}"></td>
				</tr>
				<!-- 			<tr> -->
				...
				<tr>
					<td colspan="2" align="center"><input type="submit"
						name="promotionProject" value="Update"></td>
				</tr>
				<tr>
